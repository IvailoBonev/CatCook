    ...
    public partial class Seed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ApplicationUserId", "AvatarImageUrl", "City", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "Points", "SecurityStamp", "Status", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
                    { "0464d803-7820-4ec4-bb42-d75b5a1fcb7c", 0, null, null, "Sofia", "085580e5-8fb3-447d-8bef-0435aa9d1e32", "guest@mail.com", false, "Guest", "User", false, null, "guest@mail.com", "guest@mail.com", "AQAAAAIAAYagAAAAEFXpEcf0nSPz4dUFADELtaW8QZG1BMTTfPNobvcfnVFog+X6ldDbve9Fneau95PEPw==", null, false, 0, null, null, false, "guest@mail.com" },
                    { "36998a40-6007-4cea-ac6e-c191880fa9e8", 0, null, null, "Burgas", "887533e2-734f-418a-a833-33ccb94badf8", "ivan.georgiev@example.com", false, "Ivan", "Georgiev", false, null, "ivan.georgiev@example.com", "ivan.georgiev@example.com", "AQAAAAIAAYagAAAAEMeVycsg/daKhGOW+Flhg3lGNhoEcEbKNeOjzGgkIe6x1uws74QwdYyDcnbANhmS6w==", null, false, 0, null, null, false, "ivan.georgiev@example.com" }
                });
