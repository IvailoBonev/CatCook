    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0464d803-7820-4ec4-bb42-d75b5a1fcb7c", 0, null, "Sofia", "9709e2dd-e9a9-4c4b-8b51-100d90b77778", "guest@mail.com", false, "Guest", false, "User", false, null, "guest@mail.com", "guest@mail.com", "AQAAAAIAAYagAAAAEF3rTGPYAI3AYhwWuSpQLoLtSEB6tegjiFIkLvkhbKDBQSwYtNJPIQv94oA43eRFiA==", null, false, 0, "Guest", "2b2b1c7f-b29a-409d-8391-81b7ce5bb719", null, false, "guest@mail.com" },
                    { "36998a40-6007-4cea-ac6e-c191880fa9e8", 0, null, "Burgas", "42e4023d-b533-410b-b728-4b017d5f207a", "ivan.georgiev@example.com", false, "Ivan", false, "Georgiev", false, null, "ivan.georgiev@example.com", "ivan.georgiev@example.com", "AQAAAAIAAYagAAAAECf+yEfdq0rP/WvfU5iHKUZACwcK2GGy1bCEqoAbrnSyDw1JqoFwUX6P7o/EQiLpIg==", null, false, 0, "Ivan_G", "35452e57-7ecd-472b-87f9-c26a67bbc35c", null, false, "ivan.georgiev@example.com" },
                    { "bb7a3df5-42fc-4458-be02-ebc18a9ca65c", 0, null, "Unknown", "253bf8a6-06e3-4901-82ec-65f7d578bf94", "admin@example.com", false, "The", false, "Admin", false, null, "admin@example.com", "admin@example.com", "AQAAAAIAAYagAAAAEAxH9vUaV611CGH2mn8cpufiymjhRvktE+BIda04I+okp3JYvrMMxwUduKLlTGxpzA==", null, false, 0, "Admin", "2d3ea0ff-ed47-430e-98ba-2b0036aef82c", null, false, "admin@example.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 3, 3, 16, 17, 56, 482, DateTimeKind.Local).AddTicks(2321), false, "Hi everyone! I'm trying to make a classic Caesar salad at home, but I’m struggling with the dressing. My main issue is getting the right balance of flavors—it’s either too tangy or too mild. I’m using anchovies, garlic, Dijon mustard, olive oil, lemon juice, and Parmesan, but something feels off. Should I adjust the ratios, or am I missing a key ingredient? Also, any tips for getting the texture just right? Thanks in advance!", "Need Help Perfecting My Caesar Salad Dressing!", "36998a40-6007-4cea-ac6e-c191880fa9e8" },
                    { 2, new DateTime(2025, 3, 3, 16, 17, 56, 482, DateTimeKind.Local).AddTicks(2798), false, "Hey yall! I’m trying to make a classic cheesecake, but I’m running into a few issues. My main problem is getting the texture right—it’s either too dense or ends up cracking on top. I’m using cream cheese, eggs, sugar, and a graham cracker crust. Should I adjust baking time or temperature? Also, do I need to use a water bath, or is there another trick to keep it smooth? Any advice would be greatly appreciated. Thanks!", "Help Needed with Cheesecake Recipe!", "36998a40-6007-4cea-ac6e-c191880fa9e8" }
                });
