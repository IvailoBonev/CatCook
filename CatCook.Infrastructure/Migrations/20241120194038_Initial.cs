        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Text = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false, comment: "The content of the forum"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descipriton = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false, comment: "A description of the recipe"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Text = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false, comment: "The comment content"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Image identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ImageUrl = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false, comment: "The url of the image"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
