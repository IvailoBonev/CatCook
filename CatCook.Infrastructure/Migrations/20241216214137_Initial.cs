        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rating = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "The ratings of the recipe by users"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0464d803-7820-4ec4-bb42-d75b5a1fcb7c", 0, null, null, "Sofia", "7dfc2e14-723a-4de1-abe3-aacaafda3317", "guest@mail.com", false, "Guest", "User", false, null, "guest@mail.com", "guest@mail.com", "AQAAAAIAAYagAAAAEG9m0Fju6GIQn2UEtlh8+x7jNvBfiLl/C5cbnedJE/HnItvs33ypk6cKiC9YqrwkQg==", null, false, 0, "Guest", "f415b9f9-7c2b-4b44-95ce-e5ecd7a70956", null, false, "guest@mail.com" },
                    { "36998a40-6007-4cea-ac6e-c191880fa9e8", 0, null, null, "Burgas", "081b01a8-310d-4c44-86fd-c10ce0173ee7", "ivan.georgiev@example.com", false, "Ivan", "Georgiev", false, null, "ivan.georgiev@example.com", "ivan.georgiev@example.com", "AQAAAAIAAYagAAAAEJ1QDXueOpa8O9RV/fWEkvfH1JTXyXNPEKLARA8KV/MvKS/KW/tY4dHyRrc5ehlq2g==", null, false, 0, "Ivan_G", "9c6b181d-b37e-4e95-b352-4e4bf1113407", null, false, "ivan.georgiev@example.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 12, 16, 23, 41, 36, 235, DateTimeKind.Local).AddTicks(9803), false, "Hi everyone! I'm trying to make a classic Caesar salad at home, but I’m struggling with the dressing. My main issue is getting the right balance of flavors—it’s either too tangy or too mild. I’m using anchovies, garlic, Dijon mustard, olive oil, lemon juice, and Parmesan, but something feels off. Should I adjust the ratios, or am I missing a key ingredient? Also, any tips for getting the texture just right? Thanks in advance!", "Need Help Perfecting My Caesar Salad Dressing!", "36998a40-6007-4cea-ac6e-c191880fa9e8" },
                    { 2, new DateTime(2024, 12, 16, 23, 41, 36, 236, DateTimeKind.Local).AddTicks(229), false, "Hey yall! I’m trying to make a classic cheesecake, but I’m running into a few issues. My main problem is getting the texture right—it’s either too dense or ends up cracking on top. I’m using cream cheese, eggs, sugar, and a graham cracker crust. Should I adjust baking time or temperature? Also, do I need to use a water bath, or is there another trick to keep it smooth? Any advice would be greatly appreciated. Thanks!", "Help Needed with Cheesecake Recipe!", "36998a40-6007-4cea-ac6e-c191880fa9e8" }
                });
